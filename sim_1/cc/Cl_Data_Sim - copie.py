...
class Data_Sim:
	...
	def __init__(self,val_name_file_with_veh_ap_ev_end_sim_to_read,val_path_veh_res_when_in_fres_folder,val_name_sim_user_file="Dsu"):
		...
		#vatiable indicating if the turn prob will be estimated during the sim
		self._turn_prob_estimated=val_turn_prob_estimated
		...
		#the name of the file where the veh appear event remaininf in the event list by the end of the sim are stored
		...
		#if we wish to employe a previously generated veh demand, we create the dictionary with the veh information
		#and the dictionary of the entry link information
		if self._creation_new_dem == List_Explicit_Values.initialisation_value_to_zero:
		...
		#if a given demand wil be employed, we create a dict, key=id entry lk, value=[...., t_veh_appear, ...]
		elif self._creation_new_dem == List_Explicit_Values.initialisation_value_to_minus_one:
			
			self._dict_information_entry_lk_given_demand=self.fct_creat_dict_information_entry_link_given_demand()
			#print("HERE",self._dict_information_entry_lk_given_demand[1])
			#import sys
			#sys.exit()
...
#*****************************************************************************************************************************************************************************************
	...
	def get_turn_prob_estimated(self):
		return self._turn_prob_estimated
...
#*****************************************************************************************************************************************************************************************
	#method returning the variable indicating how the split ratios will be computed
	def get_type_split_ratio_calcul(self):
		return self._type_split_ratio_calcul
...
#*****************************************************************************************************************************************************************************************
	...
	def set_turn_prob_estimated(self,n_v):
		self._turn_prob_estimated=n_v
...
#*****************************************************************************************************************************************************************************************
	#method modifying the variable indicating how the split ratios will be computed
	def set_type_calcul_split_ratios(self,n_v):
		self._type_calcul_split_ratios=n_v
