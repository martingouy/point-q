...
#*****************************************************************************************************************************************************************************************
	...
	def fct_calcul_average_sum_que_t_sim_1(self,val_path_list_files,val_total_nb_network_queues):
...
#method returning the average value sum of the queues at each t sim, from the queue files, regarding the total number of network queues
	#average value sum of all the network queues at time t= the sum of network queeus at time t/ total number of network queeus
	def fct_calcul_average_sum_que_t_sim(self,val_path_list_files,val_total_nb_network_queues,li_sum_1):
...
#***************************************************************************************************************************************************************************************** 
	#method writing a file with the average (over the number of network queues) sum of all queues during sim
	def fct_write_file_average_sum_que_t_sim(self,val_total_nb_network_ques,val_li_sum_1):
		
		#list with  [.., [t, sum of queues],...]
		li=self.fct_calcul_average_sum_que_t_sim(val_path_list_files=self._folder_que_evol_files,val_total_nb_network_queues=val_total_nb_network_ques,li_sum_1=val_li_sum_1)
...
#***************************************************************************************************************************************************************************************** 
	...
	val_li_phrases=["t start/t end period, avearage value of the sum of the queues"]):
		...
		file=open(self._folder_average_sum_ques_per_period+"/"+\
		File_Stats_Anal_Folders_And_Files.name_file_average_sum_ques_per_period_over_nb_t_instances_within_period,"w")
...
#*****************************************************************************************************************************************************************************************
	...
	val_li_phrases_mean_trav_dist=["1st line=(id entry lk,  id exit link),other lines:  t_start, t_end period (1st, 2nd column), mean traveled distance, total nb veh  (3rd column) "]):
		...
		#HEREself.fct_write_files_control_evolution_per_intersection(val_dic_ev_type=dict_db_file_1,val_time_unit=val_t_unit,val_li_phrases=["t_start stage act. duration (1st colm) t_end stage act. duration (2nd colm"])
		#import sys
		#sys.exit()
		...
		#file with the average sum of queus per period (average over the nb of t instances belonging to the period)
		self.fct_write_average_sum_ques_per_period_over_nb_t_instances_within_period(va_li_sum_ques=li,va_sim_dur=val_dur_sim,\
		...
		self.fct_write_file_average_sum_que_t_sim(val_total_nb_network_ques=len(di_1),val_li_sum_1=li)
		import sys
		sys.exit()
...
val_name_fol_FRes="Series_Sim-Wed-16-Apr-2014_22-16-49"
