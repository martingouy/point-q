...
class Control_Actuate:
	...
	val_li_param_control_MP_without_red_clear=None,val_li_param_control_MP_Pract_without_red_clear=None):
...
#*****************************************************************************************************************************************************************************************
	#method returning the list with the param of MP Pract without red cleat
	def get_li_param_control_MP_Pract_without_red_clear(self):
		return self._li_param_control_MP_Pract_without_red_clear
