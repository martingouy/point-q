...
class Vehicle:
	...
	val_index_current_veh_link_location_in_path_list_when_given_destination=-1):
...
#*****************************************************************************************************************************************************************************************
	...
	def fct_update_veh_after_choosing_queue(self,val_associated_phase_to_current_queue_location,val_t_arrival_queue):
