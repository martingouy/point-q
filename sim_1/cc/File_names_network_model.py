...
#the name fo the file indicating the type of the veh routing related to each entry link
val_name_file_rout_type_entry_lk_mixed_manag="fi_rout_type_entry_lk_mixed_manag.txt" 
