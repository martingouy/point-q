...
#*****************************************************************************************************************************************************************************************
#the name of the file indicating for each internal link the  link ids from which vehicles arrive in the link (depend upon the existing phases)
...
val_name_folder_with_files_demand_param_when_varying_demand="fo_demand_param_variation"
