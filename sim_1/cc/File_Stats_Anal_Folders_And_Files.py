...
#the name of the FILE to write file with the value of the sum of the queue during the sim
name_file_sum_queue_evol="fi_sum_evol_que"
#*****************************************************************************************************************************************************************************************
#the name of the FILE to write filewitht he average value of the sum of the queue 
name_file_average_sum_queue_evol="fi_average_sum_evol_que"
#*****************************************************************************************************************************************************************************************
...
name_file_mean_length_sum_queues="fi_mean_length_sum_ques"
#*****************************************************************************************************************************************************************************************
...
val_name_file_mean_of_aver_sojourn_time="fi_mean_of_aver_soj_time" 
#*****************************************************************************************************************************************************************************************
...
name_file_nb_veh_prob_sum_que="fi_nb_veh_prob_sum_ques"

#*****************************************************************************************************************************************************************************************
val_name_file_wm_sd_series_sim="fi_wm_sd_series_sim"
#*****************************************************************************************************************************************************************************************
#the name of the file with the mean travel time and the departed vehicles of the series of sims
val_name_file_mean_tr_t_nb_dep_veh_series_sims="fi_mean_tr_t_nb_dep_veh_series_sims"
