...
def fct_calc_queue_id(val_netw, id_veh_current_lk, id_final_destination_lk):
	...
	k = 2
	paths = sp.sp_algorithms_ksp_yen_with_turn_restricted_dijkstra(graph, id_veh_current_lk, id_final_destination_lk, k, True)
	# print "Found {0} shortest paths:".format(len(paths), paths)
	# for path in paths:
