...
def admissible_intersection_control_object_next_period_mp_pract_without_red_clear(t_actuel,t_start_sim,v_sim_dur,v_inters,v_netwk,v_li_param_control,v_round_precis,\
v_t_round_precis,v_t_end_current_netwk_control_matrix,v_ti_unit,v_marge_dt,v_initial_small_val=-10**10):
	...
	if t_actuel==t_start_sim:	
		...
		val_param_comparaison=v_li_param_control[1],val_round_precision=v_round_precis,val_init_small_val=v_initial_small_val)==1:
