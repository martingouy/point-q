...
val_param_comparaison,val_round_precision,val_init_small_val):
	...
	val_network=val_netw,val_round_prec=val_round_precision)
	
	fct_select_inters_control_stage_exerting_higher_pressure(\
	va_intersection=val_intersect,va_network=val_netw,va_round_prec=val_round_precision,va_init_small_val=val_init_small_val)
		...
		#val_exerted_pres_new_selected_stage-pres_cur_stage > val_param_comparaison)

	if val_exerted_pres_new_selected_stage-pres_cur_stage > val_param_comparaison:
		return 1
	else:
		return 0
...
v_t_round_precis,v_t_end_current_netwk_control_matrix,v_ti_unit,v_marge_dt,v_initial_small_val=-10**10):
	...
	if t_actuel==t_start_sim:	
		...
		val_param_comparaison=v_li_param_control[2],val_round_precision=v_round_precis,val_init_small_val=v_initial_small_val)==1:
