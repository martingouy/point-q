...
#*****************************************************************************************************************************************************************************************
#method calculating the  pressure exerted by  a phase
...
v_t_end_current_netwk_control_matrix,v_ti_unit,v_marge_dt,v_initial_small_val=-10**10):
	...
	if t_actuel==t_start_sim:	
		...
		val_t_start_control= t_start_red_clear, \
		val_t_end_control= t_end_current_icm_rc,val_duration_control=duration_idle_time,\
		val_cycle_duration_associated_with_control=duration_cycle,val_type_control=Cl_Control_Actuate.TYPE_CONTROL[0],val_t_update_ctrl=t_upd_ctrl)
		...
		#if the currently employed MP stage is going to be applied (no exam of control update)
		else:
