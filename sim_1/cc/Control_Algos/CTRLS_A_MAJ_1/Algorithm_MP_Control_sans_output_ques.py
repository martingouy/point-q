...
def admissible_intersection_control_object_next_period_mp_no_output_que(v_intersection,v_network,di_param_control,v_round_prec,v_t_round_prec,\
...
############################################################################################################ 
	...
	val_cycle_duration_associated_with_control=duration_cycle,val_type_control=Cl_Control_Actuate.TYPE_CONTROL[9],\
	...
	return[li_ico, List_Explicit_Values.initialisation_value_to_nine,List_Explicit_Values.initialisation_value_to_one]
