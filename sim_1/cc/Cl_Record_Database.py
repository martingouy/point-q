...
class Record_Database:
	...
	val_type_control=-1,\
	val_current_inters_turn_ratio_val={},\
	val_new_estim_inters_turn_turn_ratio_val={},\
	...
	val_veh_added_when_que_state_update=-1,\
	val_veh_suppressed_when_que_state_update=-1):
	#,val_prob_rout_prop_netw={},val_prob_rout_prop_current_lk=[]):
		...
		#the time at which the vehicle arrived at the current link
		...
		#variable indicating whether the vehicle is added when que state update
		self._veh_added_when_que_state_update=val_veh_added_when_que_state_update
		
		
		#variable indicating whether the vehicle is suppressed when que state update
		self._veh_suppressed_when_que_state_update=val_veh_suppressed_when_que_state_update
...
#*****************************************************************************************************************************************************************************************
	#method returning the variable indicating whether the vehicle is added when que state update
	def get_veh_added_when_que_state_update(self):
		return self._veh_added_when_que_state_update
#*****************************************************************************************************************************************************************************************
	#method retuning the variable indicating whether the vehicle is suppressed when que state update
	def get_veh_suppressed_when_que_state_update(self):
		return self._veh_suppressed_when_que_state_update
#*****************************************************************************************************************************************************************************************
...
#*****************************************************************************************************************************************************************************************
	#method modifuing the variable indicating whether the vehicle is added when que state update
	def set_veh_added_when_que_state_update(self,n_v):
		self._veh_added_when_que_state_update=n_v
#*****************************************************************************************************************************************************************************************
	#method modifying the variable indicating whether the vehicle is suppressed when que state update
	def set_veh_suppressed_when_que_state_update(self,n_v):
		self._veh_suppressed_when_que_state_update=n_v
#*****************************************************************************************************************************************************************************************
	...
	def fct_write_object_in_db_file(self):
		...
		self._veh_added_when_que_state_update,\
		self._veh_suppressed_when_que_state_update])
