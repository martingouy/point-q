...
##on retourne 
#[li_ico, List_Explicit_Values.initialisation_value_to_eleven=type next control to employ, 1 ou 0 according as if an event end_next_decision control will /not be generated]
...
val_t_end_current_intersection_control,val_t_unit,val_t_round_prec,val_dt):
	...
	for i in val_li_param_ft_ctrl:
		...
		if i[0]>0:
			...
			val_cycle_duration_associated_with_control=i[2])
			#,\
