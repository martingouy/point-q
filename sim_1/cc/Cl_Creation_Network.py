...
#*****************************************************************************************************************************************************************************************
	...
	v_nb_comment_lines_ft_off,v_nb_comment_lines_fa,v_nb_comment_lines_fa_max_green):
		...
		#using the same type of control
			...
			#print("va_di_file_par_ft_offset_control",va_di_file_par_ft_offset_control)
			#print()
			#import sys
			#sys.exit()
		...
		#using the same type of control
			...
			va_di_file_par_mp_practical_control=Global_Functions_Network.fct_reading_file_MP_Pract_control(\
			name_file_to_read=File_Sim_Name_Module_Files.val_name_folder_with_control_param_files+"/"+\
			...
			di_rep[v_type_control]=va_di_param_mp_without_rc
			...
			va_di_param_mp_pract_without_rc=Global_Functions_Network.fct_reading_file_MP_pract_without_rc_control(\
			name_file_to_read=File_Sim_Name_Module_Files.val_name_folder_with_control_param_files+"/"+\
			File_Sim_Name_Module_Files.val_name_file_values_mp_pract_without_rc_control,\
			nb_comment_lines=v_nb_comment_lines_mp)
			
			di_rep[v_type_control]=va_di_param_mp_pract_without_rc
...
#*****************************************************************************************************************************************************************************************
	...
	#,val_turn_ratios_estimated):
		...
		#using the same type of control
			...
			#print("v_li_param_inters_ctrl FT",v_li_param_inters_ctrl[1],"offs",v_li_param_inters_ctrl[0])
		...
		#using the same type of control
			...
			#indice_choix_duree=-1
			ctrl_act_obj=Cl_Control_Actuate.Control_Actuate(val_li_param_control_MP_Practical_ctrl=v_li_param_inters_ctrl,\
			val_type_employed_ctrl=v_type_control,val_type_ctrl_categ=v_control_categ)
			#,\
			#val_turn_ratios_estim=val_turn_ratios_estimated)
			...
			ctrl_act_obj=Cl_Control_Actuate.Control_Actuate(val_li_param_control_MP_without_red_clear=v_li_param_inters_ctrl,\
			val_type_employed_ctrl=v_type_control,val_type_ctrl_categ=v_control_categ)
			...
			ctrl_act_obj=Cl_Control_Actuate.Control_Actuate(val_li_param_control_MP_Pract_without_red_clear=v_li_param_inters_ctrl,\
			val_type_employed_ctrl=v_type_control,val_type_ctrl_categ=v_control_categ)
...
#*****************************************************************************************************************************************************************************************
	...
	dict_id_nd_param_turn_ratio_estim={},val_dict_estim_rp={},val_di_id_link_val_link={}):
		...
		#print()
		#print("HERE",di_ctrl_param_inters)
		#import sys
		#sys.exit()
		#print()
	...
	val_sim_duration=None,val_round_prec=2,val_di_id_nd_with_estim_turn_ratios=None,val_indicat_type_veh_final_dest=None):
		...
		for i in val_dict_id_node_id_entry_links_to_network:
			...
			for j in val_dict_id_node_id_entry_links_to_network[i]:
				...
				di_queue_max_queue_size_et_sat_flow_phases_queue_type_entry_lk,\
				val_cur_service_rate=total_que_serv_rate)
